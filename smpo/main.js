...
$(function() {
  ...
  function set_settings() {
    ...
    settings.defaultredirect = 'https://wj.qq.com/s2/11196816/1a1f';
    ...
    settings.condition_1_likes = [60000, 9999999]; 
    ...
    settings.condition_2_likes = [15000,35000,50000,60000,112000,115000];  
    ...
    settings.condition_3_likes = [10000, 13000,25000,35000,40000,65000,98900,100000,11500]; 
	...
	settings.condition_1_adjusted_likes = [12000, 14000,15000,35000,40000,80000,90000,100000,115000]; // 9
    ...
    settings.likes_by = ['陈伟祺','LYM','Ann','Sinyeeee','余梓茵','Y','杨浩宇','伟毅','可怡']; 
  }
